...
if (id == 'request_date') {
		...
		//For Confirmation Date : Employee For Confirmation
			if (id == 'date_of_confirmation') {
            $('_date_of_confirmation_calendar').style.display = 'none';
            if (document.getElementById(id).value != '') {
                var cross = $('date_of_confirmation').value
				var date = new Date();
                ...
                if (crossdate < new_date) {
				   ...
				   $('date_of_confirmation').value = null
                }
				else 
				{
					return true;
